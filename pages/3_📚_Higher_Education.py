...
st.write(
    "These charts show the percent distribution of institutions providing S&E higher education by level of degree."
)
...
data = pd.DataFrame(
    {
        ...
        "Private for-profit": [22.8, 6.7, 3.9],
    }
).set_index("Institutions and degrees")

fig = px.bar(data, orientation="h", barmode="stack")
fig.update_layout(
    title="Associate's Degrees",
    xaxis_title="",
    yaxis_title="Institutions and degrees",
    legend_title=None,
...
data = pd.DataFrame(
    {
        ...
        "Private for-profit": [12.5, 4.9, 1.9],
    }
).set_index("Institutions and degrees")
...
data = pd.DataFrame(
    {
        ...
        "Private for-profit": [9.9, 8.0, 4.1],
    }
).set_index("Institutions and degrees")
...
data = pd.DataFrame(
    {
        ...
        "Private for-profit": [4.0, 6.0, 4.6],
    }
).set_index("Institutions and degrees")
...
data = pd.DataFrame(
    {
        ...
        "State support for higher education per full-time equivalent student (2012 constant $)": [
            7360,
            7346,
            7126,
            6648,
...
fig.add_trace(
    go.Scatter(
        ...
        name="State support for higher education per full-time equivalent student (2012 constant $)",
    ),
    secondary_y=False,
)
fig.add_trace(
    go.Scatter(
        ...
        name="Average undergraduate charge at public 4-year institutions as a percentage of disposable personal income (%)",
    ),
    secondary_y=True,
)
...
st.write(
    "The proportion of certain demographic groups among S&E degree recipients varies from their respective shares in the overall U.S. population."
)
...
fig = px.bar(
    ...
    orientation="h",
    barmode="group",
    title="S&E degrees awarded to women, by degree level and field: 2019",
)
fig.update_layout(
    xaxis_title="Percent",
    yaxis_title="Field",
...
st.write(
    "On average, women earn more than half of all higher education degrees, but their attainment is lower in S&E fields. While some areas have seen a reduction or elimination of gender disparities, there are still persistent gaps in others."
)
