...
st.title("The STEM Labor Force of Today: Scientists, Engineers, and Skilled Technical Workers")
...
st.write("This chart shows the proportion of occupations in the STEM fields, based on educational attainment.")

nodes = ["STEM", "Bachelor's degree or higher", "Without a bachelor's degree", "Non-STEM", "S&E", "S&E-Related", "Middle Skill"]
links = [
...
fig = go.Figure(data=[go.Sankey(
    node=dict(
      ...
      label=nodes, 
      color = ("#28847D", "#740060", "#E2523E", "#A29171", "#E1167A", "#0D1444", "yellow") 
    ),
    link=dict(
...
fig.update_layout(title_text="U.S. Workforce (in thousands), by STEM occupational and educational level: 2019")
...
data = {
    'Education and sex or race or ethnicity': ['Bachelor\'s degree or higher: women', 'Bachelor\'s degree or higher: Hispanic', 
                                               'Bachelor\'s degree or higher: Black', 'Bachelor\'s degree or higher: AIAN', 
                                               'Without a bachelor\'s degree: women', 'Without a bachelor\'s degree: Hispanic',
                                               'Without a bachelor\'s degree: Black', 'Without a bachelor\'s degree: AIAN'],
...
fig = px.bar(df, x='Education and sex or race or ethnicity', y=['2010', '2019'], 
             barmode='group', title='Education Between Race and Sex (in Percent)')

fig.update_layout(xaxis_title ='', yaxis_title ='Percent', legend_title = None, legend=dict(orientation="v"))
...
data = pd.DataFrame({
    'Occupation': ['S&E workers', 'S&E: computer and mathematical scientists', 'S&E: life scientists', 
                   'S&E: engineers', 'S&E: social and related scientists', 'S&E: physical and related scientists', 
                   'S&E-related workers', 'Non-S&E workers'],
...
fig = px.bar(data, x=["Bachelor's", "Master's", "Doctorate"], y='Occupation',
             title='Foreign-born college-educated workers by degree level and occupation in 2019', barmode='group', orientation='h')

fig.update_layout(xaxis_title ='Percent', yaxis_title ='Occuptation', legend_title = None, legend=dict(orientation="h"))
