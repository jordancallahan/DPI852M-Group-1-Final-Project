...
st.markdown(        
    """ The United States has consistently ranked in the middle of the pack in the PISA science scores compared to other countries. While there have been some improvements in recent years, the US still lags behind many other countries in these subjects.
    """
)
...
st.markdown(        
    """ On this same scale, male students outperformed female students in most OECD education systems. The magnitude of the gap varied across countries and these score gaps are an important area of focus for policymakers and educators as they seek to promote gender equity and ensure that all students have access to high-quality science education. This graph highlights the ongoing gender disparities in STEM fields, which could lead to a lack of diversity and innovation in these industries. Understanding the factors that contribute to these gaps and finding ways to address them can help to ensure that all students have equal opportunities to pursue careers in STEM and contribute to scientific advancements.
    """
)
...
st.markdown(        
    """ The United States education system is a complex web of public and private schools, and has been subject to extensive scrutiny regarding its effectiveness in preparing students for success in the global economy. Accross PISA, NEAP, and gender metrics, the US education system has struggled to keep pace with other OECD countries in terms of science and math proficiency among its students. This could lead to future concerns about the ability to remain competitive in research and development (R&D), which is critical to the both growth and innovation in the long run. College enrollment rates, however, remain relatively high in the US compared to other OECD countries, suggesting that there is still a strong appetite for higher education. Looking forward, policymakers and educators must focus on strategies to improve student outcomes in science and math in order to maintain the country's leadership in R&D and innovation.
    """
)