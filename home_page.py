...
st.set_page_config(
    layout="centered",
    page_title="R+D Expenditure - US and Worldwide",
...
st.markdown(
    """
    Welcome to our website, folks! We are a group of five students from the Harvard
    Kennedy School, taking an Advanced Data Visualization course with Professor Hong
    Qu. Our project focuses on indicators related to Science, Technology, Research, and
    Development, with a view to exploring the trends and patterns both in the United
    ...
    ahead, take a look around, and feel free to explore the data sets that we used to
    make our discoveries (please explore our GitHub too - that architecture was a fair
    amount of the project on its own!). Thanks for stopping by, and we hope you enjoy
    the website!
"""
)
